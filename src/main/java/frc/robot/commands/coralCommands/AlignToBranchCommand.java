...
public class AlignToBranchCommand extends DynamicCommand{
    ...
    protected Command getCommand(){
        return new SequentialCommandGroup(
            Commands.run(()-> {System.out.println("AAAAA");}), 
            Commands.run(() -> {
                System.out.println("please");
                if(drivetrainSubsystem.atReef == true){
                    drivetrainSubsystem.limelightAlignCommand();
                }
            }),
            // Commands.runOnce(() -> {if(drivetrainSubsystem.atReef == false){
            //     drivetrainSubsystem.goToBranch(right);
            // }}),
